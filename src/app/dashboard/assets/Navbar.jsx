...
const SearchBar = () => {
  return (
    <div className=" flex flex-row ">
      ...
      <button
        type="button"
        className="focus:outline-none  md:visible text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm md:px-5 px-1 py-2.5 me-2  dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 mx-4"
      >
        + Add More
      </button>
    </div>
